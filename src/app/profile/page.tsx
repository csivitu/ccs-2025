...
const Profile = () => {
  ...
  const domains = [
    { name: 'Tech', completed: 7, total: 10 },
    { name: 'Design', completed: 5, total: 10 },
    { name: 'Management', completed: 6, total: 10 },
  ];

  return (
    <div className="bg-[#1E2124] text-[#C9D1D9] font-sans min-h-screen flex flex-col">
      <Navbar />
      <div className="container mx-auto py-8 px-4 flex-grow">
        <div className="grid grid-cols-1 md:grid-cols-10 gap-8">
          <div className="col-span-1 md:col-span-3 flex flex-col items-center">
            ...
            <h1 className="text-[25px] font-semibold self-start mx-12">Raju Rastogi</h1>
            <p className="text-[20px] mb-4 self-start mx-12">24BCE0556</p>
            <button className="w-[296px] h-[32px] bg-[#21262D] border border-[#F0F6FC] border-opacity-10 rounded-[6px] text-[18px] flex items-center justify-center">
              Edit profile
            </button>
            <div className="w-[302px] h-[5px] bg-[#30363D] my-4"></div>
                ...
                {domains.map((domain, idx) => (
                  <div key={idx} className="mb-12">
                    <div className="flex items-center mb-2 mt-4">
                      <h4 className="text-[18px] ">Questions completed in {domain.name} Domain</h4>
