...
/>
        <span className="text-[24px] lg:text-[28px] text-[#C9D1D9] font-sans-code font-semibold leading-[20px] text-center">{domainName}</span>
      </div>
      <p className="text-[14px] text-[#9198A1] font-sans-code font-normal leading-[18px] ml-1 -mt-2">{description}</p>
      <Link href="/question">
