...
import { updateUserDetails } from "@/app/actions/about";
    ...
    <div className="h-screen bg-black sticky overflow-auto flex flex-col">
      <div className="relative flex flex-col items-center pt-8 space-y-6 px-4 sm:px-0 flex-1">
        ...
        <form
          ...
          className="w-full max-w-[630px] bg-[#151B23] border border-gray-600 rounded-[10px] flex flex-col items-center p-6 space-y-4"
        >
          ...
          <button
            type="submit"
            className="w-full max-w-[630px] h-[50px] bg-black border border-gray-600 text-white font-semibold rounded-[10px] mt-4 mb-40"
          >
            Continue
          </button>
        </form>
